...
<%@page language="java" import="acme.framework.helpers.PrincipalHelper,acme.entities.roles.Officer"%>
...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption code="master.menu.anonymous.duty.list" action="/anonymous/duty/list"/>
		</acme:menu-option>
